...
class ImplFour extends UnicastRemoteObject implements infFour{
	ImplFour() throws RemoteException{
		super();
	}
	
	public byte[] method_4(byte[] b)throws java.rmi.RemoteException{
